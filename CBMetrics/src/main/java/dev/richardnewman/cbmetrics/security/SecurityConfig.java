package dev.richardnewman.cbmetrics.security;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(AuthenticationManagerBuilder auth) throws Exception {
		String userQuery = "SELECT username, password, enabled FROM user_account WHERE username=?";
		String authQuery = "SELECT username, role FROM user_account WHERE username=?";
